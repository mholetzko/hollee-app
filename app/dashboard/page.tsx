            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
              <div className="space-y-3 p-4 rounded-lg transition-all duration-300 hover:bg-white/5">
                <div className="flex items-center gap-3 text-[#1DB954]">
                  <div className="flex items-center justify-center w-12 h-12 rounded-full bg-[#1DB954]/10 text-[#1DB954] text-xl font-bold">
                    1
                  </div>
                  <span className="font-semibold text-lg">Prepare in Spotify</span>
                </div>
                <p className="text-sm text-gray-400 leading-relaxed ml-15">
              ...
              <div className="space-y-3 p-4 rounded-lg transition-all duration-300 hover:bg-white/5">
                <div className="flex items-center gap-3 text-[#1DB954]">
                  ...
                  <span className="font-semibold text-lg">Select & Build</span>
                </div>
                <p className="text-sm text-gray-400 leading-relaxed ml-15">
              ...
              <div className="space-y-3 p-4 rounded-lg transition-all duration-300 hover:bg-white/5">
                <div className="flex items-center gap-3 text-[#1DB954]">
                  ...
                  <span className="font-semibold text-lg">Design Segments</span>
                </div>
                <p className="text-sm text-gray-400 leading-relaxed ml-15">
              ...
              <div className="space-y-3 p-4 rounded-lg transition-all duration-300 hover:bg-white/5">
                <div className="flex items-center gap-3 text-[#1DB954]">
                  ...
                  <span className="font-semibold text-lg">Start Riding</span>
                </div>
                <p className="text-sm text-gray-400 leading-relaxed ml-15">
