  ...
  return (
    <div className="flex items-center gap-2">
      <Button
        ...
        disabled={hasExistingSegments}
        title={hasExistingSegments ? "Example can only be loaded on empty tracks" : "Load example workout template"}
        className="text-xs"
      >
        {hasExistingSegments ? "Has Workout" : "Load Example"}
      </Button>
